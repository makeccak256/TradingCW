...
df2 = yf.download(tickers='AMZN', start=datetime(2023,3,27), end=datetime(2023,4,3), interval="1m")
df2.to_csv('AMZN_1m_2.csv')
df3 = yf.download(tickers='AMZN', start=datetime(2023,3,19), end=datetime(2023,3,26), interval="1m")
df3.to_csv('AMZN_1m_3.csv')
df4 = yf.download(tickers='AMZN', start=datetime(2023,3,13), end=datetime(2023,3,18), interval="1m")
